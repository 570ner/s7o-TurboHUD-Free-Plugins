...
3. Press F8 in-game to open the "s7o HUD Menu".

## Main menu

Default hotkey: F8

Use it to toggle plugins, change visual options, manage TTS alerts, set some hotkeys, and control the built-in QoL tools.
