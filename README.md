...
1. Install TurboHUD Free from the link above.
2. Extract the plugin .ZIP into your TurboHUD Free folder so the files are here:
...
```text
C:\TurboHUD\plugins\s7o\s7o_HUD_MENU.cs
```

3. Start TurboHUD Free.
4. Press **F8** in-game to open the **s7o HUD Menu**.

## Main menu

Default hotkey: **F8**

Use the HUD Menu to toggle plugins, change visual options, manage TTS alerts, set hotkeys, and control the built-in QoL tools.
...
| **s7o_ArmoryBugFix**           | Armory reliability fix for the crafted primal/Armory equip bug. Helps validate and retry failed build swaps.                                                            |
| **s7o_AutoLoot**               | Auto pickup helper with item filters, improved material/reward pickup, stacked-loot speedup, inventory-full feedback, and optional Talk to Urshi with return assistance. |
| **s7o_AutoSkill**              | General skill automation helper for simple timed/conditional skill use, with selected-world-interaction safeguards.                                                                 |
...
| **s7o_Pestilence_RGK**         | Necromancer Pestilence/RGK helper with adaptive elite/RG targeting, cached hover recovery, configurable targeting/teleport hotkeys, and optional Zei's 50-yard circle. |
...
| **s7o_TipsHelper**             | Visual helper for ancient/primal drops, inventory-full alerts, Trash HP Bars, health globes, progress orbs, player markers, and Blood is Power progress.                |
...
| **s7o_ZDH_Helper**             | zDH helper for Iceblink, Odyssey and Marked for Death uptime, with optional support-skill automation.                                                                  |


## Optional plugin

[s7o Zoom Aware & Extended Controls](https://www.ownedcore.com/forums/diablo-3/turbohud/turbohud-community-plugins/1111555-s7o-zoom-aware-plugin-turbohud-free-lightningmod.html) is a separate manual download and is not included in this plugin pack.
